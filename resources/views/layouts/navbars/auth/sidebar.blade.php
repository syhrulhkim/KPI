        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'billing' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Membina dan Mengemaskini</span>
                </a>
            </li>
            @else
            @endif --}}
            ...
            {{-- @if (Auth::user()->role != "admin")
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tahap-kepuasan-pelanggan' ? 'active' : '' }}"
                    href="{{ route('tahap-kepuasan-pelanggan') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Tahap Kepuasan Pelanggan</span>
                </a>
            </li>
            @else
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Kecekapan Kemahiran</span>
                </a>
            </li>
            @else
            @endif --}}
            ...
            {{-- @if (Auth::user()->role != "admin")
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'ofi-ncr' ? 'active' : '' }}"
                    href="{{ route('ofi-ncr') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                    ...
                    <span class="nav-link-text ms-1">OFI & NCR</span>
                </a>
            </li>
            @else
            @endif --}}
            ...
            <li class="nav-link mb-0">
                <a href="javascript:;"
                    class="btn btn-primary btn-md active px-5 text-white" role="button" aria-pressed="true">
