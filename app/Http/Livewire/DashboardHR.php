...
class DashboardHR extends Component
{
    public function render()
    {
        ...
        $hncemp = User::where([['department', '=', 'High Network Client (HNC)'] , ['role', '=', 'employee']])->orderBy('created_at','desc')->get();
        ...
        $hncempcount = User::where([['department', '=', 'High Network Client (HNC)'] , ['role', '=', 'employee']])->count();
