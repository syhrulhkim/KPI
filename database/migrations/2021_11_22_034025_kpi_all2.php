...
class KpiAll2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('kpi_all', function (Blueprint $table) { 
            $table->string('weightage_kecekapan');
            $table->string('total_score_kecekapan');
            $table->string('weightage_nilai');
            $table->string('total_score_nilai');
        });
    }
